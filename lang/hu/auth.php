...
return [
    ...
    */
    ...
    'client_brand_title'  => 'Az Ön AURELIS CAPITAL GROUP<br>ügyfélfiókja',
    ...
    'staff_brand_title'   => 'AURELIS CAPITAL GROUP<br>Adminisztráció',
    ...
    'staff_notice'        => 'Ez a portál kizárólag a AURELIS CAPITAL GROUP munkatársai számára érhető el. Minden bejelentkezés naplózásra kerül.',
    ...
    'account_blocked_email_subject'       => 'AURELIS CAPITAL GROUP fiókja zárolásra került',
    ...
    'account_blocked_email_notice'        => 'Ha nem Ön kezdeményezte ezeket a próbálkozásokat, ne kattintson erre a linkre, és azonnal vegye fel a kapcsolatot a AURELIS CAPITAL GROUP ügyfélszolgálatával.',
    'account_blocked_email_footer'        => 'A link 48 óráig érvényes.',

    // OTP email
    'otp_email_subject'      => 'Bejelentkezési kódja — AURELIS CAPITAL GROUP',
    ...
    'otp_email_notice_body'  => 'A AURELIS CAPITAL GROUP soha nem kéri el ezt a kódot telefonon vagy üzenetben. Ha nem Ön kérte ezt a kódot, hagyja figyelmen kívül ezt az e-mailt.',
    ...
    'pwa_ios_title'     => 'Telepítse a AURELIS CAPITAL GROUP alkalmazást iPhone-jára',
