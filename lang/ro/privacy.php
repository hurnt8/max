...
return [
    ...
    'information_collection_list' => [
        'Informații pe care ni le furnizați direct, precum numele, adresa, adresa de e-mail, numărul de telefon, informații privind situația dumneavoastră etc.',
        ...
        'Informații provenite de la terți, precum asociații partenere, parteneri bancari pentru plata donațiilor, sau surse publice.',
    ],
    ...
    'information_use_list' => [
        'A furniza și gestiona programele noastre de ajutor, inclusiv evaluarea eligibilității dumneavoastră și urmărirea dosarului dumneavoastră.',
        ...
        'A comunica cu dumneavoastră, inclusiv pentru a vă informa despre stadiul cererii dumneavoastră de ajutor, actualizările programelor noastre și noutățile noastre.',
    ...
    'information_sharing_list' => [
        'Partenerii și furnizorii noștri de servicii care ne ajută să furnizăm și să îmbunătățim programele noastre de ajutor.',
        'Partenerii noștri bancari, pentru a asigura plata securizată a donațiilor și a gestiona riscurile asociate.',
        'Autoritățile de reglementare și guvernamentale, atunci când legea o impune.',
        'Terți, în cadrul unei tranzacții, precum o fuziune, achiziție sau reorganizare.',
    ],
    ...
    'policy_updates_text' => 'Putem actualiza periodic această politică de confidențialitate pentru a reflecta modificările practicilor și programelor noastre. Vă încurajăm să consultați regulat această pagină pentru a lua cunoștință de actualizări. Data ultimei actualizări este indicată în partea de sus a acestei politici.',
