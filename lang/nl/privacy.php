...
return [
    ...
    'introduction_text' => 'Bij ' . site_name() . ' zetten wij ons in om uw privacy te beschermen en te respecteren. Dit privacybeleid legt uit hoe wij uw persoonlijke gegevens verzamelen, gebruiken, bekendmaken en beschermen wanneer u onze website en onze online hulpprogramma\'s gebruikt. Door gebruik te maken van onze website, aanvaardt u de in dit beleid beschreven praktijken.',
    ...
    'information_collection_list' => [
        'Informatie die u ons rechtstreeks verstrekt, zoals uw naam, adres, e-mailadres, telefoonnummer, informatie over uw situatie, enz.',
        ...
        'Informatie afkomstig van derden, zoals partnerorganisaties, bankpartners voor de uitbetaling van donaties, of openbare bronnen.',
    ],
    ...
    'information_use_list' => [
        'Onze hulpprogramma\'s te leveren en te beheren, met inbegrip van de beoordeling van uw geschiktheid en de opvolging van uw dossier.',
        ...
        'Met u te communiceren, onder meer om u op de hoogte te brengen van de status van uw hulpaanvraag, updates van onze programma\'s en ons nieuws.',
    ...
    'information_sharing_list' => [
        'Onze partners en dienstverleners die ons helpen bij het leveren en verbeteren van onze hulpprogramma\'s.',
        'Onze bankpartners, om de veilige uitbetaling van donaties te waarborgen en de bijbehorende risico\'s te beheren.',
        'Toezichthoudende en overheidsinstanties wanneer dit wettelijk vereist is.',
        'Derden in het kader van een transactie, zoals een fusie, overname of reorganisatie.',
    ],
    ...
    'policy_updates_text' => 'Wij kunnen dit privacybeleid van tijd tot tijd bijwerken om veranderingen in onze praktijken en programma\'s weer te geven. Wij raden u aan deze pagina regelmatig te raadplegen om op de hoogte te blijven van updates. De datum van de laatste update staat bovenaan dit beleid vermeld.',
