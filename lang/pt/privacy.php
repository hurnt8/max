...
return [
    ...
    'introduction_text' => 'Na ' . site_name() . ', estamos comprometidos em proteger e respeitar sua privacidade. Esta política de privacidade explica como coletamos, usamos, divulgamos e protegemos suas informações pessoais quando você utiliza nosso site e nossos programas de ajuda online. Ao usar nosso site, você aceita as práticas descritas nesta política.',
    ...
    'information_collection_list' => [
        'Informações que você nos fornece diretamente, como seu nome, endereço, e-mail, número de telefone, informações relativas à sua situação, etc.',
        ...
        'Informações de terceiros, como associações parceiras, parceiros bancários para o pagamento dos donativos, ou fontes públicas.',
    ],
    ...
    'information_use_list' => [
        'Fornecer e gerir os nossos programas de ajuda, incluindo a avaliação da sua elegibilidade e o acompanhamento do seu processo.',
        'Melhorar nosso site e serviços, incluindo analisando como você usa nosso site e personalizando sua experiência.',
        'Comunicar com você, especialmente para informá-lo sobre o estado do seu pedido de ajuda, atualizações dos nossos programas e as nossas novidades.',
    ...
    'information_sharing_list' => [
        'Nossos parceiros e prestadores de serviços que nos ajudam a fornecer e melhorar nossos programas de ajuda.',
        'Nossos parceiros bancários, para assegurar o pagamento seguro dos donativos e gerir os riscos associados.',
        'Autoridades regulatórias e governamentais, quando exigido por lei.',
        'Terceiros no contexto de uma transação, como fusão, aquisição ou reorganização.',
    ],
    ...
    'policy_updates_text' => 'Podemos atualizar esta política de privacidade de tempos em tempos para refletir mudanças em nossas práticas e programas. Recomendamos que você verifique esta página regularmente em busca de atualizações. A data da última atualização está indicada no topo desta política.',
    ...
    'contact_details' => [
        site_name(),
        'Endereço: Rua de Santo António 33, 7200-175, Portugal',
        'E-mail: ' . site_email(),
        'Telefone: ' . site_phone() . ' ',
    ],
];
