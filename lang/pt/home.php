...
return [
    ...
    'reliability_quality_description' => 'Na ' . site_name() . ', oferecemos soluções de empréstimo claras e confiáveis, respaldadas por avaliações positivas de clientes e total transparência.',
    ...
    'optimal_security_description' => 'Seus dados pessoais estão seguros conosco. A ' . site_name() . ' utiliza protocolos de segurança avançados para proteger sua privacidade. Nosso suporte está disponível 24/7 para qualquer assistência.',
    ...
    'rights_reserved' => '© ' . site_name() . '. 2024. Todos os direitos reservados.',
