...
return [
    ...
    */
    ...
    'max' => [
        ...
        'file' => 'Файлът :attribute не трябва да надвишава :max КБ.',
    ...
    'mimetypes' => 'Файлът :attribute трябва да бъде от тип: :values.',
    'min' => [
        'array' => 'Полето :attribute трябва да съдържа поне :min елемента.',
        'file' => 'Файлът :attribute трябва да бъде поне :min КБ.',
    ...
    'uploaded' => 'Качването на файла :attribute не бе успешно. Възможно е да е твърде голям.',
    ...
    */
    ...
    'attributes' => [
        ...
        'activity'         => 'дейност',
        'doc_type'         => 'тип документ',
        'id_photo_recto'   => 'документ за самоличност (лице)',
        'id_photo_verso'   => 'документ за самоличност (гръб)',
        'message'          => 'съобщение',
        'password'         => 'парола',
        'amount'           => 'сума',
        'duration'         => 'срок',
