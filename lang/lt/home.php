...
return [
    ...
    'auto_loan_details' => 'Paskolos galimybės įsigyti savo svajonių automobilį.',
    'student_loan' => 'Studento paskola',
    ...
    'notice' => 'pastaba',
    'from' => 'Nuo',
    'popular_loan_title' => 'Populiarios paskolos',
    'personal_loan_subtitle' => 'Labiausiai žiūrimos ir pageidaujamos paskolos',

    'title4' => 'Greitai ir saugiai gaukite paskolą.',
    'text4' => 'Mūsų paskolų paslaugų pasirinkimo pranašumai.',
    'competitive_rates' => 'Konkurencingi įkainiai',
    'competitive_rates_description' => 'Pasinaudokite konkurencingomis paskolos palūkanų normomis.',
    'guaranteed_security' => 'Garantuotas saugumas',
    'guaranteed_security_description' => 'Jūsų informacija yra saugi ir konfidenciali.',
    'quick_turnaround' => 'Greitos operacijos',
    'quick_turnaround_description' => 'Gaukite greitą atsakymą ir greitai prieinamas lėšas.',
    '24/7_support' => 'Palaikymas 24/7',
    '24/7_support_description' => 'Mūsų komanda gali atsakyti į visus jūsų klausimus.',

    'custom_loan_services' => 'Pasinaudokite mūsų pritaikytomis paskolų paslaugomis',
    'reliability_quality' => 'Skaidrumas ir patikimumas',
    'reliability_quality_description' => site_name() . ' siūlome aiškius ir patikimus skolinimo sprendimus, paremtus teigiamais klientų atsiliepimais ir visišku skaidrumu.',
    ...
    'optimal_security_description' => 'Jūsų asmeniniai duomenys yra saugūs pas mus. „ ' . site_name() . '“ naudoja pažangius saugos protokolus, kad apsaugotų jūsų privatumą. Mūsų pagalba teikiama 24 valandas per parą, 7 dienas per savaitę.',
    ...
    'projects_completed_description' => 'Užbaigti projektai',
    'benefits' => [
        '1' => 'Susisiekite su patyrusiais finansų srities profesionalais',
        '2' => 'Pasinaudokite mūsų personalizuotomis klientų aptarnavimo paslaugomis ir raskite geriausius pasiūlymus',
    ...
    'loan_types' => [
        ...
        'mortgage_loans' => 'Nekilnojamojo turto paskolos',
        'auto_loans' => 'Automobilių paskolos',
        'student_loans' => 'Studentų paskolos',
    ],
    'support' => [
        'title' => 'Palaikymas',
        'help_support' => 'Pagalba ir palaikymas',
        'transaction_security' => 'Sandorio saugumas',
        'responsible_loan_policy' => 'Atsakingos paskolos politika',
    ],
    'subscribe' => [
        'title' => 'Prenumeruoti',
    ...
    'rights_reserved' => '© ' . site_name() . '. 2024. Visos teisės saugomos.',
