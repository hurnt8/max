...
return [
    ...
    'client_brand_title'  => 'Twoja strefa<br>klienta ' . site_name(),
    ...
    'staff_brand_title'   => 'Administracja<br>' . site_name(),
    ...
    'staff_notice'        => 'Ten portal jest zarezerwowany wyłącznie dla pracowników ' . site_name() . '. Wszystkie logowania są rejestrowane.',
    ...
    'account_blocked_email_subject'       => 'Twoje konto ' . site_name() . ' zostało zablokowane',
    ...
    'account_blocked_email_notice'        => 'Jeśli to nie Ty dokonywałeś tych prób, nie klikaj w link i natychmiast skontaktuj się z pomocą techniczną ' . site_name() . '.',
    'account_blocked_email_footer'        => 'Link ważny przez 48 godzin.',

    'otp_email_subject'      => 'Twój kod logowania — ' . site_name(),
    ...
    'otp_email_notice_body'  => site_name() . ' nigdy nie poprosi Cię o ten kod przez telefon ani wiadomość. Jeśli nie prosiłeś o ten kod, zignoruj ten email.',
    ...
    'pwa_ios_title'     => 'Zainstaluj aplikację ' . site_name() . ' na iPhonie',
