...
return [
    ...
    */
    ...
    'client_brand_title'  => 'Jūsu AURELIS CAPITAL GROUP<br>klienta telpa',
    ...
    'staff_brand_title'   => 'AURELIS CAPITAL GROUP<br>administrācija',
    ...
    'staff_notice'        => 'Šis portāls ir paredzēts tikai AURELIS CAPITAL GROUP darbiniekiem. Visas pieteikšanās tiek reģistrētas.',
    ...
    'account_blocked_email_subject'       => 'Jūsu AURELIS CAPITAL GROUP konts ir bloķēts',
    ...
    'account_blocked_email_notice'        => 'Ja šos mēģinājumus neveicāt jūs, nespiediet uz šīs saites un nekavējoties sazinieties ar AURELIS CAPITAL GROUP atbalstu.',
    'account_blocked_email_footer'        => 'Saite derīga 48 stundas.',

    'otp_email_subject'      => 'Jūsu pieteikšanās kods — AURELIS CAPITAL GROUP',
    ...
    'otp_email_notice_body'  => 'AURELIS CAPITAL GROUP nekad neprasīs šo kodu pa tālruni vai īsziņā. Ja jūs šo kodu nepieprasījāt, lūdzu, ignorējiet šo e-pastu.',
    ...
    'pwa_ios_title'     => 'Instalējiet AURELIS CAPITAL GROUP lietotni savā iPhone',
