...
return [
    ...
    'success_loan' => 'Su solicitud de ayuda se ha enviado con éxito. Le proporcionaremos una respuesta lo antes posible.',
    'error_loan' => 'Se produjo un error al enviar su solicitud de ayuda. Inténtelo de nuevo más tarde.',

    // Emails de solicitud de ayuda
    'months'               => 'meses',
    'month_abbr'           => 'mes',
    'optional'             => 'opcional',
    'loan_admin_subject'   => 'Nueva solicitud de ayuda',
    'loan_admin_intro'     => 'Una persona acaba de enviar una solicitud de ayuda a través del sitio web de ' . site_name() . '.',

    'loan_confirm_subject'   => 'Su solicitud de ayuda está siendo procesada',
    'loan_confirm_greeting'  => 'Hola :name,',
    'loan_confirm_body'      => 'Hemos recibido su solicitud de ayuda por un importe de :amount :currency a lo largo de :duration meses. Actualmente está siendo procesada por nuestro equipo.',
    ...
    'loan_conditions_text'   => 'Para recibir ayuda, es necesario ser mayor de edad y poder exponer su situación. Cada caso se examina con atención y consideración.',
    ...
    'docs_subject'   => 'Documentos — Solicitud de ayuda',
    'docs_intro'     => 'La persona ha enviado sus documentos para completar su solicitud de ayuda.',
    'docs_name'      => 'Nombre',
