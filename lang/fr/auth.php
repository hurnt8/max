...
return [
    ...
    */
    ...
    'client_brand_title'  => 'Votre espace<br>client AURELIS CAPITAL GROUP',
    ...
    'staff_brand_title'   => 'Administration<br>AURELIS CAPITAL GROUP',
    ...
    'staff_notice'        => 'Ce portail est réservé aux agents AURELIS CAPITAL GROUP. Toutes les connexions sont journalisées.',
    ...
    'account_blocked_email_subject'       => 'Votre compte AURELIS CAPITAL GROUP a été bloqué',
    ...
    'account_blocked_email_notice'        => 'Si vous n\'êtes pas à l\'origine de ces tentatives, ne cliquez pas sur ce lien et contactez immédiatement le support AURELIS CAPITAL GROUP.',
    'account_blocked_email_footer'        => 'Lien valable 48 heures.',

    // OTP email
    'otp_email_subject'      => 'Votre code de connexion — AURELIS CAPITAL GROUP',
    ...
    'otp_email_notice_body'  => 'AURELIS CAPITAL GROUP ne vous demandera jamais ce code par téléphone ou par message. Si vous n\'avez pas demandé ce code, ignorez cet email.',
    ...
    'pwa_ios_title'     => 'Installer l\'app AURELIS CAPITAL GROUP sur votre iPhone',
