...
@section('title','Modifier le modèle — Financement')
@section('page_title','Modifier le modèle — Financement')
...
<div class="d-flex align-items-start justify-content-between flex-wrap gap-3 page-hdr">
  ...
  <div style="display:flex;gap:.5rem;flex-wrap:wrap;align-items:center">
    @if($template->hasDocxTemplate())
    <a href="{{ route('admin.financing-contract-templates.docx.preview', $template) }}"
       class="btn-ghost btn-sm-pro" target="_blank">
      <i class="fas fa-file-word me-1"></i>Aperçu DOCX
    </a>
    <a href="{{ route('admin.financing-contract-templates.docx.download', $template) }}"
...
<div class="row g-4">
  ...
  <div class="col-xl-8">
    ...
    <form action="{{ route('admin.financing-contract-templates.update', $template) }}"
    ...
    <div class="card-pro" id="docx-section">
      <div class="card-pro-hdr">
        <div>
          ...
          <div style="font-size:.72rem;color:var(--c-muted);margin-top:.15rem">
            Génération DOCX via ZipArchive — polices, tableaux et mise en forme préservés à 100 %
          </div>
        </div>
        @if($template->hasDocxTemplate())
      ...
      <div class="card-pro-body">
        ...
        <form action="{{ route('admin.financing-contract-templates.docx.upload', $template) }}"
