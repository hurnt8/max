      ...
      <div class="row g-3">
        ...
        <div class="col-sm-4">
          ...
          <select name="locale" class="form-control-pro">
            ...
            @foreach(['fr'=>'Français','en'=>'English','pl'=>'Polski','es'=>'Español','bg'=>'Български','hu'=>'Magyar','it'=>'Italiano','de'=>'Deutsch','lt'=>'Lietuvių','ro'=>'Română','lv'=>'Latviešu','nl'=>'Nederlands'] as $code=>$lbl)
