...
.tpl-banner { background:linear-gradient(135deg,#071A33,#12315C); border-radius:14px; padding:1.375rem 1.25rem; color:#fff }
.tpl-banner-name { font-size:.9375rem; font-weight:800; margin-bottom:.375rem; line-height:1.3 }
.tpl-banner-type { display:inline-flex; align-items:center; gap:.35rem; background:rgba(201,162,39,.15); border:1px solid rgba(201,162,39,.3); border-radius:999px; padding:.2rem .65rem; font-size:.68rem; font-weight:700; color:#C9A227; margin-bottom:1rem }
.tpl-banner-type.html-type { background:rgba(201,162,39,.15); border-color:rgba(201,162,39,.3); color:#DEC066 }
