...
.tpl-banner { background:linear-gradient(135deg,#0B1A2E,#112237); border-radius:14px; padding:1.375rem 1.25rem; color:#fff }
...
.tpl-banner-type.html-type { background:rgba(200,169,81,.15); border-color:rgba(200,169,81,.3); color:#D4B96A }
