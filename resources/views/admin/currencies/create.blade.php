...
@section('title', 'Ajouter une devise — AURELIS CAPITAL GROUP')
@section('page_title', 'Ajouter une devise')

@section('content')

<div class="d-flex align-items-start justify-content-between flex-wrap gap-3 page-hdr">
  <div>
    <h4>Ajouter une devise</h4>
      ...
      <div class="card-pro-body">
        <div class="row g-3">
          <div class="col-md-4">
            ...
            <input type="text" name="code" class="form-control-pro" value="{{ old('code') }}" placeholder="BRL" maxlength="3" style="text-transform:uppercase" required>
          </div>
          <div class="col-md-4">
            <label class="form-label-pro">Symbole *</label>
            <input type="text" name="symbol" class="form-control-pro" value="{{ old('symbol') }}" placeholder="R$" required>
          </div>
          <div class="col-md-4">
            <label class="form-label-pro">Drapeau (emoji)</label>
            <input type="text" name="flag_emoji" class="form-control-pro" value="{{ old('flag_emoji') }}" placeholder="🇧🇷">
          </div>
          <div class="col-12">
            <label class="form-label-pro">Nom affiché *</label>
            <input type="text" name="name" class="form-control-pro" value="{{ old('name') }}" placeholder="Real brésilien (BRL)" required>
          </div>
          <div class="col-12">
            <label class="form-label-pro">Montants suggérés</label>
            <input type="text" name="preset_amounts" class="form-control-pro" value="{{ old('preset_amounts') }}" placeholder="6000,18000,30000,60000,120000,300000,450000,570000">
