  ...
  <div class="ca-settings-list">
    ...
    <div class="ca-settings-item" x-data="langMenu()" @click.stop>
      ...
      <div class="ca-settings-item__text">
        ...
        <div class="ca-settings-item__sub">{{ ['fr'=>'Francais','en'=>'English','pl'=>'Polski','es'=>'Espanol','bg'=>'Balgarski','hu'=>'Magyar','it'=>'Italiano','de'=>'Deutsch','lt'=>'Lietuviu','ro'=>'Romana','lv'=>'Latviesu'][app()->getLocale()] ?? app()->getLocale() }}</div>
      </div>
      ...
      <div x-show="open" @click.outside="close()" x-transition
        ...
        @foreach(['fr'=>'Francais','en'=>'English','pl'=>'Polski','es'=>'Espanol','bg'=>'Balgarski','hu'=>'Magyar','it'=>'Italiano','de'=>'Deutsch','lt'=>'Lietuviu','ro'=>'Romana','lv'=>'Latviesu'] as $lc => $label)
