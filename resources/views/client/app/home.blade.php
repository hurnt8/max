  ...
  <div class="h-header__actions">
    <div x-data="langMenu()" style="position:relative">
      ...
      <div x-show="open" x-cloak @click.outside="close()" x-transition
        ...
        @foreach(['fr'=>'Français','en'=>'English','pl'=>'Polski','es'=>'Español','bg'=>'Български','hu'=>'Magyar','it'=>'Italiano','de'=>'Deutsch','lt'=>'Lietuvių','ro'=>'Română','lv'=>'Latviešu','nl'=>'Nederlands','pt'=>'Português','sk'=>'Slovenčina','el'=>'Ελληνικά'] as $lc => $label)
