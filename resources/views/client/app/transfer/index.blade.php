...
.trf-hero__bal{font-family:'Montserrat',sans-serif;font-size:2rem;font-weight:900;color:#fff;line-height:1}
...
.trf-action--send .trf-action__ico{background:linear-gradient(145deg,#D2B789,#B8883E);box-shadow:0 4px 14px rgba(184,136,62,.4)}
.trf-action--recv .trf-action__ico{background:linear-gradient(145deg,#D2B789,#B8883E);box-shadow:0 4px 14px rgba(184,136,62,.35)}
...
.trf-item__amt{font-family:'Montserrat',sans-serif;font-size:.9375rem;font-weight:800}
