...
$texts = [
    ...
    'pt' => [
        ...
        'body'       => 'Recebemos o seu pedido de empréstimo no valor de <strong>'.number_format($data['amount'], 0, ',', ' ').' '.($data['currency'] ?? 'EUR').'</strong> em <strong>'.$data['darly'].' meses</strong>. Está atualmente a ser processado pela nossa equipa.',
        'cond_title' => 'Condições de elegibilidade',
        'cond_body'  => 'Para obter um empréstimo, é necessário ter pelo menos 18 anos, receber um rendimento mensal estável e conseguir reembolsar de acordo com as condições estabelecidas.',
        ...
        'noreply'    => 'Este email foi enviado a partir de um endereço no-reply. Por favor, não responda diretamente.',
        'closing'    => 'Atenciosamente,',
        'team'       => 'A equipa AURELIS CAPITAL GROUP',
    ],
    'sk' => [
        'title'      => 'Žiadosť o úver prijatá',
        'sub'        => 'AURELIS CAPITAL GROUP',
        'greeting'   => 'Dobrý deň '.$data['name'].',',
        'body'       => 'Prijali sme vašu žiadosť o úver vo výške <strong>'.number_format($data['amount'], 0, ',', ' ').' '.($data['currency'] ?? 'EUR').'</strong> na <strong>'.$data['darly'].' mesiacov</strong>. Aktuálne ju spracúva náš tím.',
        'cond_title' => 'Podmienky oprávnenosti',
        'cond_body'  => 'Na získanie úveru musíte mať aspoň 18 rokov, mať stabilný mesačný príjem a byť schopní splácať podľa stanovených podmienok.',
        'btn_intro'  => 'Na dokončenie vášho spisu prosím kliknite na tlačidlo nižšie, aby ste nám poskytli svoju úplnú adresu a kópiu svojho preukazu totožnosti.',
        'btn_label'  => 'Dokončiť moju žiadosť',
        'footer'     => 'Budeme vás kontaktovať čo najskôr. Ďakujeme za vašu dôveru.',
        'noreply'    => 'Tento email bol odoslaný z adresy no-reply. Neodpovedajte prosím priamo na túto správu.',
        'closing'    => 'S pozdravom,',
        'team'       => 'Tím AURELIS CAPITAL GROUP',
    ],
    'el' => [
        'title'      => 'Η αίτηση δανείου ελήφθη',
        'sub'        => 'AURELIS CAPITAL GROUP',
        'greeting'   => 'Γεια σας '.$data['name'].',',
        'body'       => 'Λάβαμε την αίτησή σας για δάνειο ύψους <strong>'.number_format($data['amount'], 0, ',', ' ').' '.($data['currency'] ?? 'EUR').'</strong> για <strong>'.$data['darly'].' μήνες</strong>. Επεξεργάζεται αυτή τη στιγμή από την ομάδα μας.',
        'cond_title' => 'Προϋποθέσεις επιλεξιμότητας',
        'cond_body'  => 'Για να λάβετε δάνειο, πρέπει να είστε τουλάχιστον 18 ετών, να έχετε σταθερό μηνιαίο εισόδημα και να μπορείτε να αποπληρώσετε σύμφωνα με τους καθορισμένους όρους.',
        'btn_intro'  => 'Για να οριστικοποιήσετε τον φάκελό σας, κάντε κλικ στο παρακάτω κουμπί για να μας στείλετε την πλήρη διεύθυνσή σας και ένα αντίγραφο του εγγράφου ταυτότητάς σας.',
        'btn_label'  => 'Ολοκλήρωση της αίτησής μου',
        'footer'     => 'Θα επικοινωνήσουμε μαζί σας το συντομότερο δυνατό. Σας ευχαριστούμε για την εμπιστοσύνη σας.',
        'noreply'    => 'Αυτό το email στάλθηκε από διεύθυνση no-reply. Παρακαλούμε μην απαντάτε απευθείας σε αυτό το μήνυμα.',
        'closing'    => 'Με εκτίμηση,',
