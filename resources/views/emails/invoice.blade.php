...
$texts = [
    ...
    'pt' => ['title'=>'Nova fatura','sub'=>'Área de faturação','greeting'=>'Olá','intro'=>'Recebeu uma nova fatura da <strong>AURELIS CAPITAL GROUP</strong>.','lbl_ref'=>'Referência','lbl_issue'=>'Data de emissão','lbl_due'=>'Data de vencimento','lbl_total'=>'Montante total','lbl_desc'=>'Descrição','lbl_qty'=>'Qtd.','lbl_unit'=>'Preço unit.','lbl_line_total'=>'Total','lbl_sub'=>'Subtotal','lbl_vat'=>'IVA','lbl_ttc'=>'Total c/ IVA','lbl_note'=>'Nota','body'=>'Para qualquer questão relacionada com esta fatura, contacte o seu consultor AURELIS CAPITAL GROUP.','closing'=>'Atenciosamente,','team'=>'A equipa AURELIS CAPITAL GROUP'],
    'sk' => ['title'=>'Nová faktúra','sub'=>'Fakturačný priestor','greeting'=>'Dobrý deň','intro'=>'Prijali ste novú faktúru od spoločnosti <strong>AURELIS CAPITAL GROUP</strong>.','lbl_ref'=>'Referencia','lbl_issue'=>'Dátum vystavenia','lbl_due'=>'Dátum splatnosti','lbl_total'=>'Celková suma','lbl_desc'=>'Popis','lbl_qty'=>'Množ.','lbl_unit'=>'Jedn. cena','lbl_line_total'=>'Spolu','lbl_sub'=>'Medzisúčet','lbl_vat'=>'DPH','lbl_ttc'=>'Spolu s DPH','lbl_note'=>'Poznámka','body'=>'V prípade akýchkoľvek otázok týkajúcich sa tejto faktúry kontaktujte svojho poradcu AURELIS CAPITAL GROUP.','closing'=>'S pozdravom,','team'=>'Tím AURELIS CAPITAL GROUP'],
    'el' => ['title'=>'Νέο τιμολόγιο','sub'=>'Χώρος τιμολόγησης','greeting'=>'Γεια σας','intro'=>'Λάβατε ένα νέο τιμολόγιο από την <strong>AURELIS CAPITAL GROUP</strong>.','lbl_ref'=>'Αναφορά','lbl_issue'=>'Ημερομηνία έκδοσης','lbl_due'=>'Ημερομηνία λήξης','lbl_total'=>'Συνολικό ποσό','lbl_desc'=>'Περιγραφή','lbl_qty'=>'Ποσ.','lbl_unit'=>'Τιμή μον.','lbl_line_total'=>'Σύνολο','lbl_sub'=>'Υποσύνολο','lbl_vat'=>'ΦΠΑ','lbl_ttc'=>'Σύνολο με ΦΠΑ','lbl_note'=>'Σημείωση','body'=>'Για οποιαδήποτε ερώτηση σχετικά με αυτό το τιμολόγιο, επικοινωνήστε με τον σύμβουλό σας της AURELIS CAPITAL GROUP.','closing'=>'Με εκτίμηση,','team'=>'Η ομάδα AURELIS CAPITAL GROUP'],
];
