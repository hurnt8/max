...
$docTypes = [
    ...
    'sk' => ['passport'=>'Cestovný pas','id_card'=>'Občiansky preukaz','residence_permit'=>'Povolenie na pobyt','driving_license'=>'Vodičský preukaz'],
    'el' => ['passport'=>'Διαβατήριο','id_card'=>'Δελτίο ταυτότητας','residence_permit'=>'Άδεια διαμονής','driving_license'=>'Άδεια οδήγησης'],
];
$texts = [
    'fr' => [
    ...
    'pt' => [
        ...
        'body'      => 'Recebemos os seus documentos (morada e documento de identificação). A nossa equipa irá analisá-los e dar-lhe uma resposta dentro de <strong>24 horas</strong>.',
        'lbl_name'  => 'Nome',
        'lbl_doc'   => 'Tipo de documento',
        'lbl_addr'  => 'Morada',
    ...
    'sk' => [
        'title'     => 'Dokumenty prijaté',
        'sub'       => 'AURELIS CAPITAL GROUP',
        'greeting'  => 'Dobrý deň '.$data['name'].',',
        'body'      => 'Prijali sme vaše dokumenty (adresa a doklad totožnosti). Náš tím ich preskúma a odpovie vám do <strong>24 hodín</strong>.',
        'lbl_name'  => 'Meno',
        'lbl_doc'   => 'Typ dokumentu',
        'lbl_addr'  => 'Adresa',
        'footer'    => 'Ďakujeme za vašu dôveru a sme vám k dispozícii pre akékoľvek otázky.',
    ...
    'el' => [
        'title'     => 'Έγγραφα ελήφθησαν',
        'sub'       => 'AURELIS CAPITAL GROUP',
        'greeting'  => 'Γεια σας '.$data['name'].',',
        'body'      => 'Λάβαμε τα έγγραφά σας (διεύθυνση και έγγραφο ταυτότητας). Η ομάδα μας θα τα εξετάσει και θα σας απαντήσει εντός <strong>24 ωρών</strong>.',
        'lbl_name'  => 'Όνομα',
        'lbl_doc'   => 'Τύπος εγγράφου',
        'lbl_addr'  => 'Διεύθυνση',
        'footer'    => 'Σας ευχαριστούμε για την εμπιστοσύνη σας και παραμένουμε στη διάθεσή σας για οποιαδήποτε ερώτηση.',
