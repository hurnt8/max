...
$texts = [
    ...
    'sk' => ['title'=>'Žiadosť zamietnutá','sub'=>'Informácia o vašom spise','greeting'=>'Dobrý deň','intro'=>'S poľutovaním vám oznamujeme, že vašu žiadosť o financovanie sa nepodarilo <strong>schváliť</strong>.','lbl_ref'=>'Referencia','lbl_amount'=>'Požadovaná suma','lbl_reason'=>'Dôvod zamietnutia','body'=>'V prípade otázok alebo na podanie novej žiadosti kontaktujte svojho poradcu.','closing'=>'S pozdravom,','team'=>'Tím AURELIS CAPITAL GROUP'],
    'el' => ['title'=>'Η αίτηση απορρίφθηκε','sub'=>'Πληροφορίες σχετικά με τον φάκελό σας','greeting'=>'Γεια σας','intro'=>'Λυπούμαστε που σας ενημερώνουμε ότι η αίτησή σας για χρηματοδότηση δεν μπόρεσε να <strong>εγκριθεί</strong>.','lbl_ref'=>'Αναφορά','lbl_amount'=>'Ζητούμενο ποσό','lbl_reason'=>'Αιτία απόρριψης','body'=>'Για οποιαδήποτε ερώτηση ή για να υποβάλετε νέα αίτηση, επικοινωνήστε με τον σύμβουλό σας.','closing'=>'Με εκτίμηση,','team'=>'Η ομάδα AURELIS CAPITAL GROUP'],
];
