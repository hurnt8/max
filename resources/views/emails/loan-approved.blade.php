...
$texts = [
    ...
    'pt' => [
        'title'    => 'Pedido N.º'.$loan->reference.' aprovado',
        'sub'      => 'Boas notícias!',
        'greeting' => 'Caro(a) '.$loan->name.',',
        'intro'    => 'Temos o prazer de informar que o seu pedido de financiamento foi <strong>aprovado</strong> pela nossa equipa.',
        'next'     => 'Próximo passo',
        'next_body'=> 'A nossa equipa está a preparar o seu contrato de empréstimo. Recebê-lo-á em breve por email com as instruções de assinatura.',
        'summary'  => 'RESUMO',
        'lbl_ref'  => 'Referência do processo',
        'lbl_amt'  => 'Montante aprovado',
        'lbl_dur'  => 'Duração',
        'lbl_mo'   => 'meses',
        'lbl_pay'  => 'Prestação mensal estimada',
        'lbl_rate' => 'Taxa anual',
        'closing'  => 'Atenciosamente,',
        'team'     => 'A equipa AURELIS CAPITAL GROUP',
    ],
    'sk' => [
        'title'    => 'Žiadosť č. '.$loan->reference.' schválená',
        'sub'      => 'Skvelá správa!',
        'greeting' => 'Dobrý deň '.$loan->name.',',
        'intro'    => 'S potešením vám oznamujeme, že váš tím schválil vašu žiadosť o financovanie.',
        'next'     => 'Ďalší krok',
        'next_body'=> 'Náš tím pripravuje vašu úverovú zmluvu. Čoskoro ju dostanete emailom spolu s pokynmi na podpis.',
        'summary'  => 'ZHRNUTIE',
        'lbl_ref'  => 'Referencia spisu',
        'lbl_amt'  => 'Schválená suma',
        'lbl_dur'  => 'Doba splácania',
        'lbl_mo'   => 'mesiacov',
        'lbl_pay'  => 'Odhadovaná mesačná splátka',
        'lbl_rate' => 'Ročná sadzba',
        'closing'  => 'S pozdravom,',
        'team'     => 'Tím AURELIS CAPITAL GROUP',
    ],
    'el' => [
        'title'    => 'Η αίτηση αρ. '.$loan->reference.' εγκρίθηκε',
        'sub'      => 'Καλά νέα!',
        'greeting' => 'Αγαπητέ/ή '.$loan->name.',',
        'intro'    => 'Έχουμε την ευχαρίστηση να σας ενημερώσουμε ότι η αίτησή σας για χρηματοδότηση <strong>εγκρίθηκε</strong> από την ομάδα μας.',
        'next'     => 'Επόμενο βήμα',
        'next_body'=> 'Η ομάδα μας ετοιμάζει τη δανειακή σας σύμβαση. Θα τη λάβετε σύντομα μέσω email με τις οδηγίες υπογραφής.',
        'summary'  => 'ΣΥΝΟΨΗ',
        'lbl_ref'  => 'Αναφορά φακέλου',
        'lbl_amt'  => 'Εγκεκριμένο ποσό',
        'lbl_dur'  => 'Διάρκεια',
        'lbl_mo'   => 'μήνες',
        'lbl_pay'  => 'Εκτιμώμενη μηνιαία δόση',
        'lbl_rate' => 'Ετήσιο επιτόκιο',
        'closing'  => 'Με εκτίμηση,',
