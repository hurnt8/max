...
$subs = [
    ...
    'en' => 'AURELIS CAPITAL GROUP — Client space',
    'es' => 'AURELIS CAPITAL GROUP — Área de clientes',
    'pl' => 'AURELIS CAPITAL GROUP — Obszar klienta',
    'bg' => 'AURELIS CAPITAL GROUP — Клиентска зона',
    'hu' => 'AURELIS CAPITAL GROUP — Ügyfélfiók',
    'it' => 'AURELIS CAPITAL GROUP — Area cliente',
    'de' => 'AURELIS CAPITAL GROUP — Kundenbereich',
