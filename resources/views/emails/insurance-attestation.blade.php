...
$texts = [
    'fr' => [
        ...
        'intro'    => 'Veuillez trouver ci-joint votre <strong>attestation d\'assurance emprunteur</strong> (référence <strong>'.$loan->reference.'</strong>) établie par Solberg Grupo dans le cadre de votre dossier de financement.',
    ...
    'en' => [
        ...
        'intro'    => 'Please find attached your <strong>borrower insurance certificate</strong> (reference <strong>'.$loan->reference.'</strong>) issued by Solberg Grupo in connection with your financing application.',
    ...
    'es' => [
        ...
        'intro'    => 'Encontrará adjunto su <strong>certificado de seguro de prestatario</strong> (referencia <strong>'.$loan->reference.'</strong>) emitido por Solberg Grupo en el marco de su solicitud de financiación.',
    ...
    'pl' => [
        ...
        'intro'    => 'W załączeniu przesyłamy <strong>zaświadczenie ubezpieczenia kredytobiorcy</strong> (numer referencyjny <strong>'.$loan->reference.'</strong>) wystawione przez Solberg Grupo w ramach Państwa wniosku kredytowego.',
    ...
    'bg' => [
        ...
        'intro'    => 'Моля, намерете приложено вашето <strong>удостоверение за застраховка на кредитополучателя</strong> (референция <strong>'.$loan->reference.'</strong>), издадено от Solberg Grupo във връзка с вашето досие за финансиране.',
    ...
    'hu' => [
        ...
        'intro'    => 'Mellékelten megtalálja <strong>adósvédelmi biztosítási igazolását</strong> (hivatkozási szám: <strong>'.$loan->reference.'</strong>), amelyet a Solberg Grupo állított ki finanszírozási ügye keretében.',
    ...
    'it' => [
        ...
        'intro'    => 'In allegato trovi il tuo <strong>attestato di assicurazione del mutuatario</strong> (riferimento <strong>'.$loan->reference.'</strong>) rilasciato da Solberg Grupo nell\'ambito della tua pratica di finanziamento.',
    ...
    'de' => [
        ...
        'intro'    => 'Anbei finden Sie Ihre <strong>Restschuldversicherungsbescheinigung</strong> (Referenz <strong>'.$loan->reference.'</strong>), die von Solberg Grupo im Rahmen Ihrer Finanzierungsakte ausgestellt wurde.',
    ...
    'lt' => [
        ...
        'intro'    => 'Pridedame jūsų <strong>skolininko draudimo pažymėjimą</strong> (nuoroda <strong>'.$loan->reference.'</strong>), kurį išdavė Solberg Grupo jūsų finansavimo bylos rėmuose.',
    ...
    'ro' => [
        ...
        'intro'    => 'Veți găsi atașat <strong>certificatul dumneavoastră de asigurare a împrumutatului</strong> (referință <strong>'.$loan->reference.'</strong>) emis de Solberg Grupo în cadrul dosarului dumneavoastră de finanțare.',
    ...
    'lv' => [
        ...
        'intro'    => 'Pielikumā atradīsiet savu <strong>aizņēmēja apdrošināšanas apliecību</strong> (atsauce <strong>'.$loan->reference.'</strong>), ko izsniedza Solberg Grupo jūsu finansējuma lietas ietvaros.',
