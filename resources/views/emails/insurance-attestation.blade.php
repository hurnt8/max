...
$greetings = [
    ...
    'pt' => ['M' => 'Caro Sr. '.$loan->name.',', 'F' => 'Cara Sra. '.$loan->name.',', 'N' => 'Caro(a) '.$loan->name.','],
    'sk' => ['M' => 'Vážený pán '.$loan->name.',', 'F' => 'Vážená pani '.$loan->name.',', 'N' => 'Dobrý deň, '.$loan->name.','],
    'el' => ['M' => 'Αγαπητέ κύριε '.$loan->name.',', 'F' => 'Αγαπητή κυρία '.$loan->name.',', 'N' => 'Αγαπητέ/ή '.$loan->name.','],
];
...
$texts = [
    'fr' => [
        ...
        'intro'    => 'Veuillez trouver ci-joint votre <strong>attestation d\'assurance emprunteur</strong> (référence <strong>'.$loan->reference.'</strong>) établie par AURELIS CAPITAL GROUP dans le cadre de votre dossier de financement.',
    ...
    'en' => [
        ...
        'intro'    => 'Please find attached your <strong>borrower insurance certificate</strong> (reference <strong>'.$loan->reference.'</strong>) issued by AURELIS CAPITAL GROUP in connection with your financing application.',
    ...
    'es' => [
        ...
        'intro'    => 'Encontrará adjunto su <strong>certificado de seguro de prestatario</strong> (referencia <strong>'.$loan->reference.'</strong>) emitido por AURELIS CAPITAL GROUP en el marco de su solicitud de financiación.',
    ...
    'pl' => [
        ...
        'intro'    => 'W załączeniu przesyłamy <strong>zaświadczenie ubezpieczenia kredytobiorcy</strong> (numer referencyjny <strong>'.$loan->reference.'</strong>) wystawione przez AURELIS CAPITAL GROUP w ramach Państwa wniosku kredytowego.',
    ...
    'bg' => [
        ...
        'intro'    => 'Моля, намерете приложено вашето <strong>удостоверение за застраховка на кредитополучателя</strong> (референция <strong>'.$loan->reference.'</strong>), издадено от AURELIS CAPITAL GROUP във връзка с вашето досие за финансиране.',
    ...
    'hu' => [
        ...
        'intro'    => 'Mellékelten megtalálja <strong>adósvédelmi biztosítási igazolását</strong> (hivatkozási szám: <strong>'.$loan->reference.'</strong>), amelyet a AURELIS CAPITAL GROUP állított ki finanszírozási ügye keretében.',
    ...
    'it' => [
        ...
        'intro'    => 'In allegato trovi il tuo <strong>attestato di assicurazione del mutuatario</strong> (riferimento <strong>'.$loan->reference.'</strong>) rilasciato da AURELIS CAPITAL GROUP nell\'ambito della tua pratica di finanziamento.',
    ...
    'de' => [
        ...
        'intro'    => 'Anbei finden Sie Ihre <strong>Restschuldversicherungsbescheinigung</strong> (Referenz <strong>'.$loan->reference.'</strong>), die von AURELIS CAPITAL GROUP im Rahmen Ihrer Finanzierungsakte ausgestellt wurde.',
    ...
    'lt' => [
        ...
        'intro'    => 'Pridedame jūsų <strong>skolininko draudimo pažymėjimą</strong> (nuoroda <strong>'.$loan->reference.'</strong>), kurį išdavė AURELIS CAPITAL GROUP jūsų finansavimo bylos rėmuose.',
    ...
    'ro' => [
        ...
        'intro'    => 'Veți găsi atașat <strong>certificatul dumneavoastră de asigurare a împrumutatului</strong> (referință <strong>'.$loan->reference.'</strong>) emis de AURELIS CAPITAL GROUP în cadrul dosarului dumneavoastră de finanțare.',
    ...
    'lv' => [
        ...
        'intro'    => 'Pielikumā atradīsiet savu <strong>aizņēmēja apdrošināšanas apliecību</strong> (atsauce <strong>'.$loan->reference.'</strong>), ko izsniedza AURELIS CAPITAL GROUP jūsu finansējuma lietas ietvaros.',
    ...
    'nl' => [
        ...
        'intro'    => 'Bijgevoegd vindt u uw <strong>verzekeringsattest kredietnemer</strong> (referentie <strong>'.$loan->reference.'</strong>), afgegeven door AURELIS CAPITAL GROUP in het kader van uw financieringsdossier.',
    ...
    'pt' => [
        'title'    => 'Certificado de seguro de mutuário — N.º'.$loan->reference,
        'sub'      => 'Seguro CG-A340G',
        'greeting' => $greetings['pt'][$gender],
        'intro'    => 'Encontra em anexo o seu <strong>certificado de seguro de mutuário</strong> (referência <strong>'.$loan->reference.'</strong>) emitido pela AURELIS CAPITAL GROUP no âmbito do seu processo de financiamento.',
        'summary'  => 'RESUMO DO SEU SEGURO',
        'lbl_ref'  => 'Referência do processo',
        'lbl_montant'  => 'Montante segurado',
        'lbl_duree'    => 'Duração',
        'lbl_months'   => 'meses',
        'lbl_frais'    => 'Custos do seguro',
        'lbl_fin'      => 'Data de fim do seguro',
        'attach_note'  => 'O seu certificado de seguro CG-A340G está anexado a este email em formato PDF.',
        'contact'      => 'Para qualquer questão relativa ao seu seguro, não hesite em contactar o seu consultor.',
        'closing'      => 'Atenciosamente,',
        'team'         => 'A equipa AURELIS CAPITAL GROUP',
    ],
    'sk' => [
        'title'    => 'Potvrdenie o poistení dlžníka — č. '.$loan->reference,
        'sub'      => 'Poistenie CG-A340G',
        'greeting' => $greetings['sk'][$gender],
        'intro'    => 'V prílohe nájdete svoje <strong>potvrdenie o poistení dlžníka</strong> (referencia <strong>'.$loan->reference.'</strong>) vydané spoločnosťou AURELIS CAPITAL GROUP v rámci vášho spisu financovania.',
        'summary'  => 'ZHRNUTIE VÁŠHO POISTENIA',
        'lbl_ref'  => 'Referencia spisu',
        'lbl_montant'  => 'Poistená suma',
        'lbl_duree'    => 'Doba trvania',
        'lbl_months'   => 'mesiacov',
        'lbl_frais'    => 'Poistné',
        'lbl_fin'      => 'Dátum konca poistenia',
        'attach_note'  => 'Vaše poistné potvrdenie CG-A340G je priložené k tomuto emailu vo formáte PDF.',
        'contact'      => 'V prípade akýchkoľvek otázok týkajúcich sa vášho poistenia neváhajte kontaktovať svojho poradcu.',
        'closing'      => 'S pozdravom,',
        'team'         => 'Tím AURELIS CAPITAL GROUP',
    ],
    'el' => [
        'title'    => 'Πιστοποιητικό ασφάλισης δανειολήπτη — αρ. '.$loan->reference,
        'sub'      => 'Ασφάλιση CG-A340G',
        'greeting' => $greetings['el'][$gender],
        'intro'    => 'Θα βρείτε συνημμένο το <strong>πιστοποιητικό ασφάλισης δανειολήπτη</strong> σας (αναφορά <strong>'.$loan->reference.'</strong>) που εκδόθηκε από την AURELIS CAPITAL GROUP στο πλαίσιο του φακέλου χρηματοδότησής σας.',
        'summary'  => 'ΣΥΝΟΨΗ ΤΗΣ ΑΣΦΑΛΙΣΗΣ ΣΑΣ',
        'lbl_ref'  => 'Αναφορά φακέλου',
        'lbl_montant'  => 'Ασφαλισμένο ποσό',
        'lbl_duree'    => 'Διάρκεια',
        'lbl_months'   => 'μήνες',
        'lbl_frais'    => 'Ασφάλιστρα',
        'lbl_fin'      => 'Ημερομηνία λήξης ασφάλισης',
        'attach_note'  => 'Το πιστοποιητικό ασφάλισης CG-A340G σας επισυνάπτεται σε αυτό το email σε μορφή PDF.',
        'contact'      => 'Για οποιαδήποτε ερώτηση σχετικά με την ασφάλισή σας, μη διστάσετε να επικοινωνήσετε με τον σύμβουλό σας.',
        'closing'      => 'Με εκτίμηση,',
