...
/* ── Hero ── */
.adb-hero {
  background: linear-gradient(135deg, #071A33 0%, #12446E 60%, #12315C 100%);
  border-radius: 16px;
...
@php
  ...
  $avatarPalette = ['#2563EB','#059669','#D97706','#7C3AED','#DC2626','#0D9488','#C9A227'];
@endphp
    ...
    <div class="adb-card-body">
      ...
      <div class="adb-ring-wrap">
        <svg width="110" height="110" viewBox="0 0 120 120" style="flex-shrink:0">
          ...
          @endif
          @endforeach
          <text x="{{ $cx }}" y="{{ $cy - 3 }}" text-anchor="middle" font-size="15" font-weight="800" fill="#071A33">{{ $stats['total_loans'] }}</text>
