...
<title>Réinitialiser le mot de passe : AURELIS CAPITAL GROUP</title>
...
.icon-badge{
  ...
  display:flex;align-items:center;justify-content:center;
  margin:0 auto 1.5rem;box-shadow:0 0 28px rgba(201,162,39,.15);
}
...
<div class="page-shell">
  ...
  <div class="page-wrap">
    <div class="card">
      ...
      <p class="card-sub">Choisissez un nouveau mot de passe sécurisé pour votre compteAURELIS CAPITAL GROUP.</p>
...
function updateStrength(val) {
  ...
  var colors = ['#ef4444','#f97316','#eab308','#22c55e','#C9A227'];
