...
{{-- ══ Push Notifications ══ --}}
<div id="cxa-push-banner" style="display:none;position:fixed;bottom:calc(62px + env(safe-area-inset-bottom,0px) + .75rem);left:.875rem;right:.875rem;z-index:9000;background:#0B1A2E;border:1px solid rgba(200,169,81,.35);border-radius:16px;padding:.875rem 1rem;box-shadow:0 8px 32px rgba(11,26,46,.5);display:none;align-items:center;gap:.875rem">
  <div style="width:42px;height:42px;border-radius:13px;background:rgba(200,169,81,.18);display:flex;align-items:center;justify-content:center;flex-shrink:0">
    <i class="fas fa-bell" style="color:#D4B96A;font-size:1.1rem"></i>
  </div>
  <div style="flex:1;min-width:0">
  ...
  <div style="display:flex;flex-direction:column;gap:.4rem;flex-shrink:0">
    <button id="cxa-push-allow" style="background:linear-gradient(90deg,#D4B96A,#C8A951);color:#0B1A2E;border:none;padding:.42rem .875rem;border-radius:8px;font-size:.78rem;font-weight:700;cursor:pointer;white-space:nowrap">Activer</button>
