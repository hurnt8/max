...
class ContractService
{
    ...
    private array $translations = [
        'fr' => [
            ...
            'art3_body'      => "Le financement accordé par Solberg Grupo INVESTI est soumis à un taux d'intérêt annuel de : {taux} %.\nLes intérêts sont calculés conformément aux conditions du présent contrat.",
            ...
            'made_at'        => 'Fait le',
            'sig_lender'     => 'POUR Solberg Grupo INVESTI',
        ...
        'pl' => [
            ...
            'art3_body'      => "Finansowanie udzielone przez Solberg Grupo INVESTI podlega rocznej stopie procentowej wynoszącej : {taux} %.",
            ...
            'sig_lender'     => 'W IMIENIU Solberg Grupo INVESTI',
        ...
        'en' => [
            ...
            'art1_body'      => "This agreement defines the conditions under which Solberg Grupo INVESTI grants financing totalling {montant} {devise} to the Borrower {nom_client}.\nThe funds will be made available after full validation of the file and acceptance of these contractual conditions.",
            ...
            'art3_body'      => "The financing granted by Solberg Grupo INVESTI is subject to an annual interest rate of: {taux} %.",
            ...
            'made_at'        => 'Signed on',
            'sig_lender'     => 'FOR Solberg Grupo INVESTI',
        ...
        'es' => [
            ...
            'art1_body'      => "El presente contrato define las condiciones bajo las cuales Solberg Grupo INVESTI concede una financiación por un importe total de {montant} {devise} al Prestatario {nom_client}.\nLos fondos se pondrán a disposición tras la validación completa del expediente.",
            ...
            'art3_body'      => "La financiación concedida por Solberg Grupo INVESTI está sujeta a un tipo de interés anual del: {taux} %.",
            ...
            'made_at'        => 'Firmado el',
            'sig_lender'     => 'POR Solberg Grupo INVESTI',
