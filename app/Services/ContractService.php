...
class ContractService
{
    ...
    public function __construct()
    {
        ...
        'fr' => [
            ...
            'art3_body'      => "Le financement accordé par ' . site_name() . ' INVESTI est soumis à un taux d'intérêt annuel de : {taux} %.\nLes intérêts sont calculés conformément aux conditions du présent contrat.",
            ...
            'made_at'        => 'Fait le',
            'sig_lender'     => 'POUR ' . site_name() . ' INVESTI',
        ...
        'pl' => [
            ...
            'art3_body'      => "Finansowanie udzielone przez " . site_name() . " INVESTI podlega rocznej stopie procentowej wynoszącej : {taux} %.",
            ...
            'sig_lender'     => 'W IMIENIU ' . site_name() . ' INVESTI',
        ...
        'en' => [
            ...
            'art1_body'      => "This agreement defines the conditions under which " . site_name() . " INVESTI grants financing totalling {montant} {devise} to the Borrower {nom_client}.\nThe funds will be made available after full validation of the file and acceptance of these contractual conditions.",
            ...
            'art3_body'      => "The financing granted by " . site_name() . " INVESTI is subject to an annual interest rate of: {taux} %.",
            ...
            'made_at'        => 'Signed on',
            'sig_lender'     => 'FOR ' . site_name() . ' INVESTI',
        ...
        'es' => [
            ...
            'art1_body'      => "El presente contrato define las condiciones bajo las cuales " . site_name() . " INVESTI concede una financiación por un importe total de {montant} {devise} al Prestatario {nom_client}.\nLos fondos se pondrán a disposición tras la validación completa del expediente.",
            ...
            'art3_body'      => "La financiación concedida por " . site_name() . " INVESTI está sujeta a un tipo de interés anual del: {taux} %.",
            ...
            'made_at'        => 'Firmado el',
            'sig_lender'     => 'POR ' . site_name() . ' INVESTI',
