...
class SupportAiService
{
    ...
    private function buildSystemPrompt(User $client): string
    {
        ...
        return <<<PROMPT
Tu es l'assistant IA de support deAURELIS CAPITAL GROUP, une plateforme fintech spécialisée dans le crédit, les transferts et les services financiers.
...
- Termine TOUJOURS par : "— AssistantAURELIS CAPITAL GROUP"
